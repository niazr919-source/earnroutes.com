...
faq:
  - question: "What labels can you use above AdSense ads?"
    answer: "Only two. Google states publishers may label its ads with either “Advertisements” or “Sponsored Links”. Headings such as “Resources”, “Helpful links” or “You may also like” are treated as deceptive because they imply editorial endorsement."
  - question: "How far should ads be from buttons and links?"
    answer: "Google's placement policy warns against positioning ads near links, play buttons, download buttons and navigation, because proximity causes accidental clicks. For embedded interactive content such as games it recommends a minimum of 150 pixels between the ad and the element."
  - question: "Can you click your own AdSense ads to test them?"
    answer: "No. Google classifies clicks generated by publishers on their own live ads as invalid traffic, and the definition explicitly covers accidental clicks too. Check that a unit renders, but never interact with the ad itself."
  - question: "Where are AdSense ads not allowed at all?"
    answer: "Google prohibits ads in pop-ups or pop-unders, in emails, inside software applications, on pages that auto-refresh, and in new windows opened without a user action. Sites running AdSense may also not exceed three pop-ups."
sources:
